export default function ContactMe() {
  return (
    <div className="w-full h-full flex flex-col justify-center items-center px-4 md:px-8 relative overflow-hidden">
      <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 md:mb-8 tracking-tighter mt-8 md:mt-12">
        Let's Talk
      </h2>
      ...
      <div className="max-w-4xl w-full flex flex-col-reverse md:flex-row gap-6 md:gap-8 z-10">
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6 bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
          ...
          <div className="flex flex-row md:flex-col flex-wrap gap-4">
            <a
              href="mailto:jeeson7012@gmail.com"
              className="flex items-center gap-3 md:gap-4 text-sm md:text-base text-zinc-300 hover:text-white hover:translate-x-2 transition-all w-full"
            >
              ...
              <span className="font-medium truncate">jeeson0987@gmail.com</span>
            </a>

            <div className="flex gap-4">
              <a
                href="https://www.linkedin.com/in/jeeson-jacob-varghese-8b535b239/"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-zinc-300 hover:text-white hover:-translate-y-1 transition-all"
                title="LinkedIn"
              >
              ...
              <a
                href="https://github.com/jeeson12"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-zinc-300 hover:text-white hover:-translate-y-1 transition-all"
                title="GitHub"
              ...
              <a
                href="https://www.instagram.com/_beck_s_/"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-zinc-300 hover:text-white hover:-translate-y-1 transition-all"
                title="Instagram"
              ...
              <a
                href="https://twitter.com/JeesonJacob_"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-zinc-300 hover:text-white hover:-translate-y-1 transition-all"
                title="Twitter"
        ...
        <div className="flex-[1.5] bg-white/10 p-6 md:p-8 rounded-2xl border border-white/20 backdrop-blur-md shadow-xl">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div>
                <label className="block text-xs md:text-sm font-bold text-white/80 mb-1.5 md:mb-2 uppercase tracking-wide">
                  Name
                </label>
                <input
                  type="text"
