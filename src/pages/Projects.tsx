export default function Projects() {
  return (
    <div className="w-full h-full flex flex-col justify-center items-center px-4 md:px-8 relative overflow-hidden">
      <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-tighter mt-8 md:mt-12">Projects</h2>
      
      <div className="max-w-4xl w-full z-10 flex flex-col items-center justify-center p-8 md:p-12 bg-white/5 rounded-3xl border border-white/10 text-center">
